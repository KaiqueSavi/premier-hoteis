...
const faqData = [
    {
        question: 'Qual os horários de check-in e check-out no Barueri Premier Hotel?',
    ...
    {
        question: 'Barueri Premier Hotel tem um restaurante no local?',
        answer: 'Sim, tem restaurante no local para você aproveitar uma boa gastronomia caseira durante sua estadia.'
    },
    {
        question: 'O centro de Barueri fica a que distância de Barueri Premier Hotel?',
        answer: 'Estamos a 750 m do centro de Barueri, estação de trem e rodoviária.'
    }
];
