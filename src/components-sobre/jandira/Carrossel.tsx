...
const jandiraAmenities = 'Ar-condicionado – Artigos de toalete gratuitos – Tv canais a cabo - Toalhas - Tomada perto da cama - Mesa - Ferro de passar - Secador de cabelo - Toalhas/lençóis (taxa extra) - Serviço de despertar - Guarda-roupa ou armário - Mesa de jantar - Pisos superiores acessíveis por elevador - Arara - Papel higiênico - Frigobar - Banheiro Privativo';

// Room data with their specific images and details
const rooms = [
    {
        id: 'individual-deluxe',
        title: 'Quarto Individual Deluxe',
        capacity: 'Individual - 1 Cama de solteiro',
    ...
    },
    {
        ...
        capacity: '2 Camas de solteiro - p/ 2 pessoa',
        amenities: jandiraAmenities,
        images: [
...
const RoomCarousel = ({ images }: { images: string[] }) => {
    ...
    return (
        <div className="flex flex-col items-center w-full group">
            {/* Image Container */}
            <div className="relative w-full h-64 md:h-[300px] rounded-3xl overflow-hidden shadow-sm">
                <div
            ...
            {images.length > 1 ? (
                ...
                <div className="h-4 mt-4 mb-2 invisible"></div> // Placeholder for alignment
            )}
        </div>
    );
};
...
export default function Carrossel() {
    return (
        <section className="bg-[#f5f5f5] py-20 px-6 md:px-16 w-full">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-x-20 md:gap-y-16">
                {rooms.map((room) => (
                    <div key={room.id} className="flex flex-col items-center">
                        ...
                        <div className="mt-4 text-center flex flex-col items-center flex-grow">
                            <h3 
                                className="text-[24px] md:text-[28px] font-bold text-black mb-2"
                                style={{ fontFamily: "'Playfair Display', serif", letterSpacing: '-0.5px' }}
                            >
                                {room.title}
                            </h3>
                            
                            <p className="text-gray-700 text-[13px] md:text-[14px] mb-4">
                                {room.capacity}
                            </p>
                            
                            <p className="text-[#333333] text-[12px] md:text-[13px] leading-relaxed mb-8 max-w-[90%] md:max-w-[480px]">
                                {room.amenities}
                            </p>
            ...
            <div className="max-w-5xl mx-auto mt-24">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-900 font-bold text-sm">
                        Confira as comodidades oferecidas pela nossa unidade em Jandira / SP
                    </p>
                </div>
